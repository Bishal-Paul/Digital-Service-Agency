            ...
            <div class="slimscroll-menu" id="remove-scroll">
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu" id="side-menu">
                        ...
                        <li>
                            <a href="javascript: void(0);"><i class="fa fa-shopping-cart"></i> <span> Orders </span> <span class="menu-arrow"></span></a>
                            <ul class="nav-second-level" aria-expanded="false">
                                <li><a href="{{url('view-all-orders')}}">View All Orders</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="javascript: void(0);"><i class="fa fa-picture-o"></i> <span> Bannar </span> <span class="menu-arrow"></span></a>
                            <ul class="nav-second-level" aria-expanded="false">
                                <li><a href="{{url('add-bannar')}}">Add</a></li>
                                <li><a href="{{url('view-bannar')}}">View</a></li>
                            </ul>
                        </li>
                        ...
                        <li>
                            <a href="javascript: void(0);"><i class="fa fa-usd"></i> <span> Pricing </span> <span class="menu-arrow"></span></a>
                            <ul class="nav-second-level" aria-expanded="false">
                        ...
                        <li>
                            <a href="javascript: void(0);"><i class="fa fa-briefcase"></i><span> Recent Works </span> <span class="menu-arrow"></span></a>
                            <ul class="nav-second-level" aria-expanded="false">
                        ...
                        <li>
                            <a href="javascript: void(0);"><i class="fa fa-info-circle"></i> <span> Coupons </span> <span class="menu-arrow"></span></a>
                            <ul class="nav-second-level" aria-expanded="false">
                                <li><a href="{{url('add-coupon')}}">Add</a></li>
                                <li><a href="{{url('view-coupon')}}">View</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="javascript: void(0);"><i class="fa fa-play"></i> <span> Video </span> <span class="menu-arrow"></span></a>
                            <ul class="nav-second-level" aria-expanded="false">
                                <li><a href="{{url('add-video')}}">Add</a></li>
                                <li><a href="{{url('view-video')}}">View</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="javascript: void(0);"><i class="fa fa-info-circle"></i> <span> Site Information </span> <span class="menu-arrow"></span></a>
                            <ul class="nav-second-level" aria-expanded="false">
                                <li><a href="{{url('add-info')}}">Add</a></li>
                                <li><a href="{{url('view-info')}}">View</a></li>
                            </ul>
                        </li>

                        <li>
                            <a href="javascript: void(0);"><i class="fa fa-user"></i> <span> Users </span> <span class="menu-arrow"></span></a>
                            <ul class="nav-second-level" aria-expanded="false">
                                <li><a href="{{url('users')}}">View All</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="javascript: void(0);"><i class="fa fa-picture-o"></i> <span> Seller Info </span> <span class="menu-arrow"></span></a>
                            <ul class="nav-second-level" aria-expanded="false">
                                <li><a href="{{url('view-seller-account')}}">View Accounts</a></li>
                                <li><a href="{{url('view-seller-works')}}">View Works</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="{{ url('view-contact') }}"><i class="fi-mail"></i><span> Contact Messages </span><span class="badge badge-danger badge-pill float-right"></span></a>

                        </li>
                        <li>
                            <a href="{{ url('view-submitted-project') }}"><i class="fi-mail"></i><span> Submitted Projects </span><span class="badge badge-danger badge-pill float-right"></span></a>
                    ...
                    <ul class="list-unstyled topbar-right-menu float-right mb-0">
                        ...
                        <li class="dropdown notification-list">
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated dropdown-lg">
                                ...
                                <div class="slimscroll" style="max-height: 230px;">
                                    <!-- item-->
                                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                                        <div class="notify-icon"><img src="{{ url('backend') }}/assets/images/users/avatar-2.jpg" class="img-fluid rounded-circle" alt="" /> </div>
                                    ...
                                    <!-- item-->
                                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                                        <div class="notify-icon"><img src="{{ url('backend') }}/assets/images/users/avatar-3.jpg" class="img-fluid rounded-circle" alt="" /> </div>
                                    ...
                                    <!-- item-->
                                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                                        <div class="notify-icon"><img src="{{ url('backend') }}/assets/images/users/avatar-4.jpg" class="img-fluid rounded-circle" alt="" /> </div>
                                    ...
                                    <!-- item-->
                                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                                        <div class="notify-icon"><img src="{{ url('backend') }}/assets/images/users/avatar-5.jpg" class="img-fluid rounded-circle" alt="" /> </div>
                                    ...
                                    <!-- item-->
                                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                                        <div class="notify-icon"><img src="{{ url('backend') }}/assets/images/users/avatar-6.jpg" class="img-fluid rounded-circle" alt="" /> </div>
                        ...
                        <li class="dropdown notification-list">
                            <a class="nav-link dropdown-toggle nav-user" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                                <img src="{{ url('backend') }}/assets/images/users/avatar-1.jpg" alt="user" class="rounded-circle"> <span class="ml-1">{{Auth::user()->name ?? ""}}<i class="mdi mdi-chevron-down"></i> </span>
                            </a>
                    ...
                    <ul class="list-inline menu-left mb-0">
                        ...
                        <li>
                            <div class="page-title-box">
                                ...
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item active">Welcome to Admin Panel {{Auth::user()->name ?? ""}} !</li>
                                </ol>
                            </div>
                        </li>
